...
export const HomeDashboard: React.FC<HomeDashboardProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in pb-12">
      ...
      >
        {/* Borde animado brillante - AZUL DIAMANTE */}
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-200 via-blue-500 to-cyan-200 bg-[length:200%_100%] animate-[shimmer_3s_linear_infinite] rounded-3xl" />
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-4 sm:p-5 flex items-center gap-4">
          {/* Ícono animado - AZUL DIAMANTE */}
          <div className="relative shrink-0">
            <div className="absolute inset-0 bg-cyan-400/40 blur-xl rounded-full animate-pulse" />
            <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-cyan-200 via-blue-500 to-blue-700 text-white flex items-center justify-center shadow-2xl shadow-cyan-500/40 group-hover:rotate-6 transition-transform overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-tr from-white/40 to-transparent"></div>
              <Zap className="w-7 h-7 sm:w-8 sm:h-8 fill-current stroke-[2.5] relative" />
            </div>
          </div>
          ...
          <div className="flex-1 text-left min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="hidden sm:inline-flex items-center gap-1 bg-blue-500/20 text-cyan-200 border border-blue-500/40 text-[10px] font-black uppercase px-2 py-0.5 rounded-full">
          ...
          {/* Flecha de acción - AZUL DIAMANTE QUE BRILLA */}
          <div className="shrink-0 flex items-center gap-2">
            <span className="hidden sm:inline text-xs font-black text-cyan-200 group-hover:text-cyan-100">
              Jugar ya
            </span>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-200 to-blue-600 text-white flex items-center justify-center shadow-lg shadow-cyan-500/30 group-hover:translate-x-1 transition-transform relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-tr from-white/30 to-transparent"></div>
              <div className="absolute -top-0.5 -right-0.5 h-2 w-2 bg-white rounded-full animate-ping"></div>
